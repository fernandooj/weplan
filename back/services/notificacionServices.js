...
class notificacionService{
	...
	getByUser(idUsuario, callback){
		notificacionSchema.find({idUsuario, estado:true}).populate('idUsuario').populate('idPlan').populate('idAmigoUser').populate('idItem').populate('idUsuarioAsigna').exec(callback)
	}
