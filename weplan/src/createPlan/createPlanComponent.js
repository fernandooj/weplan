...
import AgregarAmigosComponent 	 from './agregarAmigos.js'
...
export default class createPlanComponent extends Component{
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	render(){
		const {nombre, direccion, restricciones, asignados, imagen} = this.state
		...
		return (
			<ScrollView style={CreatePlanStyle.contenedorGeneral} > 
			   ...
			   <View style={CreatePlanStyle.contenedor} >
				...
				<Modal style={CreatePlanStyle.modal} backdrop={true}  position={"top"} ref={"modal3"}>
					<AgregarAmigosComponent closeModal={(e)=>this.closemodal()} updateStateAsignados={(estado, id)=>this.updateStateAsignados(estado, id)} />
        		</Modal>
